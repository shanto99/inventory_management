...
@section('subcontent')
            ...
            <div class="col-span-12 xl:col-span-9 2xl:col-span-9 z-10">
                ...
                <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                        ...
                        <div class="text-base 2xl:text-lg justify-center sm:justify-start flex items-center text-gray-700 dark:text-gray-500 leading-3 mt-14 2xl:mt-24">
                            My Total Assets
                        ...
                        <div class="2xl:flex mt-5 mb-3">
                            ...
                            <div class="mt-5 2xl:flex 2xl:justify-center 2xl:mt-0 2xl:-ml-20 2xl:w-14 2xl:flex-none 2xl:pl-2.5">
                                <div class="font-medium inline-flex bg-theme-10 text-white rounded-full px-2 py-1 text-xs 2xl:text-sm 2xl:p-0 2xl:text-theme-10 2xl:bg-transparent 2xl:flex items-center tooltip cursor-pointer 2xl:justify-center" title="49% Higher than last month">
                                    49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                </div>
                            </div>
                        </div>
                        <div class="text-gray-600 mt-5">Last updated 1 hour ago</div>
                        <div class="2xl:text-base text-gray-700 dark:text-gray-500 mt-6 -mb-1">
                            Total net margin <span class="font-medium text-gray-800 dark:text-gray-400">$921,050</span>
                        </div>
                        <div class="mt-14 2xl:mt-24 dropdown">
                            <button class="dropdown-toggle btn btn-rounded-primary w-44 2xl:w-52 px-4 relative justify-start" aria-expanded="false">
                                Download Reports
                    ...
                    <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-black border-opacity-10 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                        ...
                        <div class="mt-10 text-gray-700 dark:text-gray-500">You have spent about 35% of your annual budget.</div>
                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 border-black border-opacity-10 border-t sm:border-t-0 border-l md:border-l-0 border-dashed -ml-4 pl-4 md:ml-0 md:pl-0">
                        <div class="boxed-tabs nav nav-tabs justify-center w-3/4 2xl:w-4/6 bg-theme-7 bg-opacity-50 text-gray-600 dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto" role="tablist">
    ...
    <div class="report-box-3 report-box-3--content grid grid-cols-12 gap-6 xl:-mt-5 2xl:-mt-8 -mb-10 z-40 2xl:z-10">
        ...
        <div class="col-span-12 2xl:col-span-3 relative z-10">
            <div class="2xl:border-l border-theme-25 pb-10 intro-y">
